...
<p>Otathan aina ensisijaisesti yhteyttä <a href="<?php echo site_url();?>liitto/tiedotus/728">tuen kautta</a>, josta eri osa-alueiden työntekijät pääsevät käsittelemään kysymyksesi. Tuessa on useita eri kategorioita, joista voit valita sopivimman. Useamman asian ollessa kyseessä tee niistä erilliset ilmoitukset. Mikäli asiasi ei koske varsinaisesti tukiasioita, ota yhteyttä vastuuhenkilöihin, joiden vastuualueet ja sähköpostiosoitteet löydät alta.</p>
...
<p>Ota yhteyttä tunnus-, työvoima- ja jaosvastaaviin <a href="<?php echo site_url();?>liitto/tiedotus/728" title="Ota yhteyttä tuen kautta">tuen</a>  kautta. </p>
   <table width="100%">
  ...
  <div class="panel-footer">Ota yhteyttä tunnus-, työvoima- ja jaosvastaaviin <a href="<?php echo site_url();?>liitto/tiedotus/728" title="Ota yhteyttä tuen kautta">tuen</a> kautta.</div>
</div>
...
<p>Ota yhteyttä rekisterityöntekijöihin <a href="<?php echo site_url();?>liitto/tiedotus/728" title="Ota yhteyttä tuen kautta">tuen</a>  kautta. </p>
   <table width="100%">
  ...
  <div class="panel-footer">Ota yhteyttä rekisterityöntekijöihin <a href="<?php echo site_url();?>liitto/tiedotus/728" title="Ota yhteyttä tuen kautta">tuen</a> kautta.</div>
</div>
